module.exports = {
    QueriesCompany:{
        ...
        SELECT_SELECT_ALL: `SELECT :TABLA.idCompany as id, companyName as opcion FROM :TABLA`,
        INSERT: `INSERT INTO :TABLA SET ?`,
        UPDATE: `UPDATE :TABLA SET ? WHERE idCompany = ?`,
        DELETE: `DELETE FROM :TABLA WHERE idCompany = ?`
    }
}