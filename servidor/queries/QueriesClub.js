...
module.exports = {
    QueriesClub: {
        SELECT_UNO: `select  
                        ...
                        c_city.cityName,
                        c_city.city_limitClubs_porExt,
                        c_city.city_limitClubs_porInt,
                        c_city.city_limitClubs_mess,
                        c_city.city_limitOthers_porExt,
                        c_city.city_limitOthers_porInt,
                        c_city.city_limitOthers_mess,
                        c_provinces.provinceid,
                        c_provinces.provinceName,
                        c_provinces.province_limitClubs_porExt,
                        c_provinces.province_limitClubs_porInt,
                        c_provinces.province_limitClubs_mess,
                        c_provinces.province_limitOthers_porExt,
                        c_provinces.province_limitOthers_porInt,
                        c_provinces.province_limitOthers_mess,                       
                        c_state.stateid,
                        c_state.stateName,
                        c_state.state_limitClubs_porExt,
                        c_state.state_limitClubs_porInt,
                        c_state.state_limitClubs_mess,
                        c_state.state_limitOthers_porExt,
                        c_state.state_limitOthers_porInt,
                        c_state.state_limitOthers_mess,
                        c_country.countryId,
                        c_country.countryName,
                        c_country.country_limitClubs_porExt,
                        c_country.country_limitClubs_porInt,
                        c_country.country_limitClubs_mess,
                        c_country.country_limitOthers_porExt,
                        c_country.country_limitOthers_porInt,
                        c_country.country_limitOthers_mess,
