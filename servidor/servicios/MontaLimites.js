...
class MontaLimites {
    ...
    static procesaDatos(dat) {
        ...
        if (datos.hasOwnProperty('club_limit_porInt') &&
            datos.hasOwnProperty('club_limit_porExt') &&
        ...
        } else if (datos.hasOwnProperty('city_limitClubs_porInt') &&
            datos.hasOwnProperty('city_limitClubs_porExt') &&
        ...
        } else if (datos.hasOwnProperty('province_limitClubs_porInt') &&
            datos.hasOwnProperty('province_limitClubs_porExt') &&
        ...
        } else if (datos.hasOwnProperty('state_limitClubs_porInt') &&
            datos.hasOwnProperty('state_limitClubs_porInt') &&
            (datos.state_limitClubs_porInt + datos.state_limitClubs_porExt) != 0) {
            console.error('d');
        ...
        } else if (datos.hasOwnProperty('country_limitClubs_porInt') &&
            datos.hasOwnProperty('country_limitClubs_porExt') &&
