export default class Comunidades {
  //  coa_id;cp
  //  cpcoa_nombre;
  //  cpcoa_pais;
  // state_limit_por;
  ...
  constructor(
    ...
    stateName = '',
    countryid = 0,
    state_limitClubs_porInt = 0,
    state_limitClubs_porExt = 0,
    state_limitClubs_mess = '',
    state_limitOthers_porInt = 0,
    state_limitOthers_porExt = 0,
    state_limitOthers_mess = 0
  ) {
